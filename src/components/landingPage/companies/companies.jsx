    ...
    <>
      <div>
        <div className="flex justify-evenly tracking-wide gap-5">
          <div className="pt-8"> <div className="h-[0.5px] w-40 bg-gray-400"></div></div>
          <div className="">
            <p className="text-xl font-bold">
              We help companies celebrate what makes them unique — <br/> from startups
              to Fortune 100 and everything in between.
            </p>
          </div>
         <div className="pt-8"> <div className="h-[0.5px] w-40 bg-gray-400 "></div></div>
          </div>
          ...
          <div className="text-center">
            <Button text="BROWSE COMPANIES" className="px-10 py-3 bg-blue-500 rounded text-white text-xs"/>
          </div>
          <div className="text-center text-blue-500 pb-20">
            <p>Hiring? <a href="#" className="underline">Learn more</a> about featuring your brand on The Muse.</p>
          </div>
