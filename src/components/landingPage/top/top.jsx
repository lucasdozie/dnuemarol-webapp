function Top() {
  return (
    <>
      <div className="bg-[length:750px,_800px] bg-no-repeat bg-[url(components/landingPage/images/left.jpeg),_url(components/landingPage/images/rightimage.webp)] bg-[position:bottom_left,_bottom_right]">
